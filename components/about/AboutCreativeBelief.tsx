...
const RU: typeof EN = {
  ...
  statement: [
    'Привлечь внимание ребёнка легко.',
    'Оставить добрый след в его сердце: вот настоящая ответственность.',
  ],
  principles: [
    {
      n: '01',
      name: 'Смысл',
      body: 'За каждой историей или продуктом должна стоять настоящая ценность для ребёнка.',
    },
    {
      n: '02',
      name: 'Красота',
      body: 'Мир, который видит ребёнок, должен обогащать его воображение.',
    },
    {
      n: '03',
      name: 'Теплота',
      body: 'Всё, что создаётся для ребёнка, должно ощущаться близким и созданным с любовью.',
    },
  ],
};
