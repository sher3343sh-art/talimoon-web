...
const RU: typeof EN = {
  m1: {
    eyebrow: 'С чего всё начиналось',
    headline: 'Всё началось с отца, который скучал по своим детям.',
    body: [
      'TALIMOON не начинался как бизнес-идея.',
      'Шерзодбека Юнусова давно волновали вопросы воспитания детей и ценностей, которые формируются в раннем возрасте. Когда он оказался вдали от собственных детей, этот интерес стал для него по-настоящему личным.',
      'У него была любовь, советы и мысли, которые он хотел донести до детей, но обычного разговора для этого казалось недостаточно.',
    ],
    question:
      'Как сделать так, чтобы важные слова, обращённые к ребёнку, оставались с ним чуть дольше?',
  },
  m2: {
    headline: 'Совет стал историей.',
    body: [
      'Шерзодбек и его дети любили превращать семейные фотографии в иллюстрации в стиле аниме: маленькая, весёлая привычка, у которой пока не было особой цели.',
      'Расстояние подсказало ему новую мысль: что, если совет прозвучит не как наставление, а будет жить внутри истории, где главным героем становится сам ребёнок?',
      'Он сделал своих детей главными героями приключения. Их настоящие фотографии превратились в персонажей истории, нарисованных в стиле аниме: теперь они не наблюдали за историей со стороны, а жили внутри неё. Его любовь и то, что он хотел сказать, стали частью самих событий.',
    ],
    statement: ['Первая книга создавалась не для продажи.', 'Она создавалась, чтобы донести до детей отцовскую любовь и то, что он хотел им сказать.'],
    artifactCaption: 'Первая книга TALIMOON',
    artifactAlt: 'Первая книга TALIMOON, созданная для одной семьи ещё до появления самого TALIMOON.',
  },
  m3: {
    body: [
      'Когда первая книга была готова в электронном виде, оставалась одна задача: превратить её в настоящую печатную книгу и передать детям. Шерзодбек в то время находился далеко.',
      'Его близкий друг Ойбек Убайдуллаев помог напечатать книгу и передать её детям.',
      'Дети увидели себя внутри истории и гордились своим отцом.',
      'Когда они скучали по нему, то снова перечитывали книгу и рассматривали картинки, будто история позволяла им ещё раз встретиться с отцом.',
    ],
    statement: 'История, созданная для одной семьи, поставила куда более важный вопрос.',
    question: 'Если одна история значила так много для одной семьи, скольким детям могла бы помочь по-настоящему значимая история?',
    transition:
      'Со временем Ойбек стал одним из первых, кто отнёсся к этой идее серьёзно. Они обменивались мыслями и вместе прорабатывали слабые места, и то, что начиналось как одна книга, постепенно вырастало во что-то большее.',
    reveal: 'Со временем у этого мира появилось имя, и Ойбек сыграл в его выборе далеко не последнюю роль.',
    afterReveal: 'То, что началось с одной книги, становится целым миром для детей.',
  },
  pdgtal: {
    eyebrow: 'Важный этап становления',
    headline: 'От идеи к большому видению',
    body: [
      'Когда TALIMOON только начинал складываться, Шерзодбек находился в Дохе и участвовал в программе Fast-Track Internship академии PDGTAL Talents Academy. Когда он решил превратить TALIMOON в настоящий проект, PDGTAL поддержал его инициативу и предоставил профессиональную среду для работы над собственной идеей.',
      'Этот период помог ему взглянуть на проект шире: выстроить продуманную стратегию, ориентироваться на премиальные международные стандарты, заранее продумать вывод продукта на рынок и увидеть TALIMOON как бренд, способный выйти за пределы одного региона.',
    ],
    conclusion:
      'TALIMOON родился из личной истории. На раннем этапе, когда эта идея превращалась в серьёзный долгосрочный проект, PDGTAL стал одним из важных источников наставничества и поддержки.',
    logoAlt: 'PDGTAL',
    place: 'Доха, Катар',
    linkAria: 'PDGTAL Talents Academy',
  },
