...
const RU: typeof EN = {
  eyebrow: 'Единая вселенная',
  headline: 'От одной истории к целому миру.',
  worlds: [
    { key: 'books', name: 'Именные книги', line: 'Ребёнок становится героем собственной истории.' },
    { key: 'yy', name: 'Юсуф и Ясмина', line: 'Персонажи, в которых ребёнок узнаёт частичку себя. Пока истории продолжаются, вместе с ними растут знания, характер, ценности и хорошие привычки.' },
    { key: 'toys', name: 'Игрушки TALIMOON', line: 'История покидает страницы книги и попадает в руки ребёнка.' },
    { key: 'library', name: 'Библиотека историй', line: 'Чтение, прослушивание и просмотр историй объединяются в одном опыте.' },
    { key: 'hayot', name: 'HAYOT для родителей', line: 'Знания и размышления о воспитании, мире ребёнка и повседневных привычках, основанные на надёжных источниках.' },
  ],
};
