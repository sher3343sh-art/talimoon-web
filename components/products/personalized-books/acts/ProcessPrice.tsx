...
const COPY_RU: typeof COPY_EN = {
  eyebrow: "Как всё создаётся",
  heading: ["Вы рассказываете.", "Мы превращаем это в книгу."],
  support: "Несколько простых шагов, и Ваш ребёнок держит в руках свою собственную историю.",
  steps: [
    {
      n: "01",
      title: "Вы рассказываете нам о своём ребёнке",
      body: "Несколько простых вопросов о его мире, увлечениях и о том, что важно для Вас.",
      img: `${IMG}/step-1-family-details.webp`,
      alt: "Семья вместе смотрит на планшет, заполняя данные о своём ребёнке",
      pos: "50% 44%",
    },
    {
      n: "02",
      title: "Мы создаём образ его мира",
      body: "Каждая сцена и иллюстрация создаются так, чтобы Ваш ребёнок чувствовал себя настоящим героем истории.",
      img: `${IMG}/step-2-create-story.webp`,
      alt: "Автор создаёт именную историю, на экране виден черновик текста и иллюстрации",
      pos: "52% 42%",
    },
    {
      n: "03",
      title: "Его книга появляется на свет",
      body: "Вы просматриваете её, она бережно печатается и попадает к Вашей семье.",
      img: `${IMG}/step-3-printed-with-care.webp`,
      alt: "Готовые именные книги в твёрдом переплёте в типографии TALIMOON, рядом подарочная коробка",
      pos: "50% 50%",
    },
  ],
  trust:
    "Твёрдый переплёт · иллюстрации в аниме-стиле по Вашим фотографиям · создаётся только на основе того, что рассказали Вы · готово за 7–10 дней",
  cta: "Начать его историю →",
};
