...
const COPY_RU: typeof COPY_EN = {
  heading: "Что бы Вы сегодня сказали своему ребёнку?",
  lines: ["«Я верю в тебя»", "«Ты можешь быть добрым»", "«У тебя всё получится»", "«Я люблю тебя»"],
  turn: "Теперь превратите это в его историю.",
  proposition: [
    "Создано для Вашего ребёнка.",
    "Написано так, чтобы тронуть его сердце.",
    "История, которой не будет больше ни у кого.",
  ],
  cta: "Создать историю моего ребёнка →",
  faqHeading: "Несколько вопросов",
  faqs: [
    {
      q: "А если я не знаю, что написать?",
      a: "Вам не нужен готовый сюжет или длинный текст. Вопросы шаг за шагом ведут Вас, а Вы просто отвечаете на них.",
    },
    {
      q: "Может ли в одной книге быть несколько детей?",
      a: "Да. Братья и сёстры могут делить одну историю, и каждый появляется в ней таким, какой он есть. При оформлении заказа доступен вариант для нескольких детей.",
    },
    {
      q: "Какие фотографии нужны?",
      a: "3–5 чётких фотографий Вашего ребёнка при хорошем освещении: несколько крупным планом и несколько в полный рост. Вы загружаете их при оформлении заказа.",
    },
    {
      q: "Сколько времени это занимает?",
      a: "После того как Вы просмотрите и одобрите историю, книга будет готова за 7–10 дней по Узбекистану и за 15–25 дней при международном заказе.",
    },
  ],
};
